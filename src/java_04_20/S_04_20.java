...
public class S_04_20 {
	...
	}	System.out.printf("총점\t%d\t%d\t%d\n","총점",subjects[0],subjects[1],subjects[2]);  // 짤라서 출력한탓에 내용이 뒤섞임 c052의내용이랑 합쳐야함.  나중에 강사님이올린 거랑 비교해보기
	    System.out.printf("총점\t%d\t%d\t%d\n","총점",subjects[0],subjects[1],subjects[2]);  // double로바꾸기.
